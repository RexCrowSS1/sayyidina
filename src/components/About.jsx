  ...
  return (
    <section id="about" className="relative py-32 px-6 overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        ...
        {/* Split text heading */}
        <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-16 leading-[1.05] brutal-title">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="bento-item-tall bento-item-wide md:col-span-2 row-span-2">
            <div className="brutal-card h-full p-3 group overflow-hidden">
          ...
          <motion.div variants={itemVariants} className="bento-item-wide col-span-2">
            <div className="brutal-card h-full p-8 flex flex-col justify-center">
          ...
          {stats.map((stat, i) => (
            <motion.div key={i} variants={itemVariants} className="col-span-1 md:col-span-1">
              <div className="brutal-card h-full p-6 flex flex-col items-center justify-center text-center group" data-cursor-hover>
                <span className="text-3xl md:text-4xl font-bold text-text mb-2 transition-transform duration-500 group-hover:scale-110">
                  {stat.number}
                </span>
          ...
          <motion.div variants={itemVariants} className="col-span-1">
            <div className="brutal-card h-full p-6 flex flex-col items-center justify-center text-center">
